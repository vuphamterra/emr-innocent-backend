$(function () {
    ...
    function getDataSet(length, min, max) {
        var a = []
    ...
    var billingBarChartWeek = echarts.init(
        document.getElementById("billing-bar-chart-week")
    )
    ...
    billingBarChartWeek.setOption(option)

    // ------------------------------
    // Basic bar chart
    // ------------------------------
    // based on prepared DOM, initialize echarts instance
    var billingBarChartMonth = echarts.init(
        document.getElementById("billing-bar-chart-month")
    )
    ...
    var option = {
        ...
        xAxis: [
            {
                type: "category",
                data: Array.from(Array(30), (_, i) => i + 1),
                axisLabel: {
                    color: "#ffffff",
                },
                axisLine: {
    ...
    // use configuration item and data specified to show chart
    billingBarChartMonth.setOption(option)
