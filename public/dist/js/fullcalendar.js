...
var FullCalendar = (function (e) {
            ...
            e: if ("function" == typeof R) {
                if (
                    ...
                    null != d.componentWillUpdate &&
                        d.componentWillUpdate(S, d.__s, b),
    ...
    function ue(e, t, n) {
        return n.func
            ? n.func(e, t)
            : ce(e[n.field], t[n.field]) * (n.order || 1)
    }
    function ce(e, t) {
        return e || t
            ? null == t
    ...
    function Tn(e, t, n) {
        var o = (function (e, t) {
                ...
                null == l &&
                    (l =
                        a && a.isTimeUnspecified && (!s || s.isTimeUnspecified))
                return r(
                    {
                        range: {
            ...
            return (
                ...
                (e.prototype.mutate = function (t) {
                    ...
                    if (n) {
                        var r = this._def,
                            o = this._context,
                            i = Ot(o.getCurrentData().eventStore, n.instanceId)
                        i = Hn(
                            i,
                            {
                                "": {
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {}
                    for (var c in ((this.eventUiBuilders = Ue(
                        n,
                        function (e, n) {
    ...
    function yr(e, t) {
        return (
            void 0 === t && (t = "day"),
            JSON.stringify({ date: rt(e), type: t })
        )
    }
    var Er,
        Sr = null
    ...
    var Or = FullCalendarVDom.Component,
        ...
        zr = FullCalendarVDom.flushToDom,
        Fr = FullCalendarVDom.unmountComponentAtNode,
        Br = (function () {
            function e(e, t, n) {
                var o = this
                ;(this.execFunc = e),
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    ...
                    !Fe(this.props, e, this.propEquality) ||
                        !Fe(this.state, t, this.stateEquality)
                )
            }),
    ...
    var so = (function (e) {
        ...
        return (
            ...
            (t.prototype.isValidDateDownEl = function (e) {
                return !(
                    F(e, ".fc-event:not(.fc-bg-event)") ||
                    F(e, ".fc-daygrid-more-link") ||
                    F(e, "a[data-navlink]") ||
                    this.isInPopover(e)
                )
            }),
                            ...
                            for (var t = 0, a = e; t < a.length; t++) {
                                ...
                                n[s.id] ||
                                    ...
                                    (o = {
                                        ...
                                        eventDragMutationMassagers: l.eventDragMutationMassagers.concat(
                                            u.eventDragMutationMassagers
                                        ),
                                        eventDefMutationAppliers: l.eventDefMutationAppliers.concat(
                                            u.eventDefMutationAppliers
                                        ),
                                        dateSelectionTransformers: l.dateSelectionTransformers.concat(
                                        ...
                                        eventResizeJoinTransforms: l.eventResizeJoinTransforms.concat(
    ...
    var go = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderInnerContent = function () {
                    ...
                    if (
                        (void 0 === o &&
                            (o = So(t.defaultContent, t.hookProps)),
                        void 0 !== o)
                    ) {
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(wt) || e.type,
                    }
                })(e, a, t, n, o)
            }
        )
    ...
    function xo(e) {
        var t = 0
        for (var n in e) e[n].isFetching && (t += 1)
        return t
    }
    function _o(e, t, n, o) {
    ...
    function Vo(e, t, n, r, o) {
        ...
        return {
            headerToolbar: e.headerToolbar
                ? zo(e.headerToolbar, e, t, n, r, o, i)
                : null,
            footerToolbar: e.footerToolbar
                ? zo(e.footerToolbar, e, t, n, r, o, i)
                : null,
            viewsWithButtons: i,
        }
    }
        ...
        lo({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, Mn(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    )
                },
    ...
    var Jo = (function () {
        function e(e) {
            ...
            ;(this.computeOptionsData = st(this._computeOptionsData)),
                (this.computeCurrentViewData = st(
                ...
                (this.parseContextBusinessHours = lt(ii)),
            ...
            for (
                var v = ko(o.calendarOptions, d, p),
                    g = {
                        ...
                        eventDrag: null,
                        eventResize: null,
                        selectionConfig: this.buildViewUiProps(p)
                            .selectionConfig,
                    },
                    m = r(r({}, p), g),
                    y = 0,
                    ...
                    (d = (function (e, t, n, r) {
                        ...
                        switch (t.type) {
                            ...
                            case "CHANGE_DATE":
                                if (
                                    !e.activeRange ||
                                    !un(e.currentRange, t.dateMarker)
                                )
    ...
    var pi = {},
        ...
        hi = {},
        vi = { startTime: Xe, duration: Xe, create: Boolean, sourceId: String }
    function gi(e) {
        var t = It(e, vi),
            n = t.refined,
            r = t.extra
                ...
                return (
                    (n.handleSegClick = function (e, t) {
                        ...
                        if (i && r.isValidSegDownEl(e.target)) {
                            var a = F(e.target, ".fc-event-forced-url"),
        ...
        bi = (function (e) {
            function t() {
                ...
                return (
                    ...
                    (t.buildViewPropTransformers = st(wi)),
                    (t.buildToolbarProps = st(Ci)),
                    ...
                    (t.registerInteractiveComponent = function (e, n) {
                        ...
                        ;(t.interactionsStore[e.uid] = o), (pi[e.uid] = r)
                    }),
                    (t.unregisterInteractiveComponent = function (e) {
                        ...
                        delete t.interactionsStore[e.uid], delete pi[e.uid]
                    }),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        u = [ki].concat(mr(l, o), e.extraClassNames || []),
        ...
        Ii = (function (e) {
            ...
            return (
                ...
                (t.prototype.computeTiming = function () {
                    ...
                    return {
                        currentState: { nowDate: r, todayRange: Pi(r) },
                        nextState: { nowDate: o, todayRange: Pi(o) },
                        waitMs: i,
                    }
                }),
    ...
    var Ni = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this
            return (t.createDayHeaderFormatter = st(Hi)), t
        }
        return (
            n(t, e),
            (t.prototype.render = function () {
                ...
                return Ar(Ii, { unit: "day" }, function (e, t) {
                    return Ar(
                        "tr",
                        null,
                        i && i(),
            ...
            return (
                ...
                (e.prototype._sliceInteraction = function (e, t, n, r) {
                    for (var o = [], i = 4; i < arguments.length; i++)
                        o[i - 4] = arguments[i]
                    if (!e) return null
                    var a = cn(e.mutatedEvents, t, Li(n, Boolean(r)), r)
                    return {
        ...
        Vi = (function (e) {
            ...
            return (
                ...
                (t.prototype.needsXScrolling = function () {
                    if (Wi.test(this.props.overflowX)) return !1
                    for (
                        var e = this.el,
                            t =
                ...
                (t.prototype.needsYScrolling = function () {
                    if (Wi.test(this.props.overflowY)) return !1
                    for (
                        var e = this.el,
                            t =
    ...
    function ji(e, t) {
        return null != t.maxHeight || Bi(e, t)
    }
    function Gi(e, t, n) {
        var r = n.expandRows
        ...
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
                n.push(
                    Ar("col", {
                        style: {
                            width: "shrink" === a.width ? Zi(t) : a.width || "",
                            minWidth: a.minWidth || "",
                        },
                    })
                )
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Ar(
                    ...
                    Boolean(!h && d.length) &&
                        Ar.apply(void 0, o(["thead", {}], d)),
                    Boolean(!h && p.length) &&
                        Ar.apply(void 0, o(["tbody", {}], p)),
                    Boolean(!h && f.length) &&
                        Ar.apply(void 0, o(["tfoot", {}], f)),
            ...
            (t.prototype.computeShrinkWidth = function () {
                return Xi(this.props.cols)
                    ? Fi(this.scrollerElRefs.getAll())
                    : 0
            }),
    ...
    ta.addStateEquality({ scrollerClientWidths: Ve, scrollerClientHeights: Ve })
    var na = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this
                return (t.elRef = Lr()), t
    ...
    function la(e) {
        ...
        return r(
            r(r({ date: n.toDate(t), view: e.viewApi }, o), {
                dayNumberText: e.showDayNumber ? n.format(t, aa) : "",
            }),
            e.extraProps
        )
    }
    var ua = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this
            return (
                (t.refineHookProps = lt(la)), (t.normalizeClassNames = yo()), t
            )
        }
        return (
            n(t, e),
    ...
    function pa(e) {
        return (
            e.event.title &&
            Ar("div", { className: "fc-event-title" }, e.event.title)
        )
    }
    var fa = function (e) {
        return Ar(jr.Consumer, null, function (t) {
    ...
    var va = (function (e) {
        ...
        return (
            ...
            (t.prototype.updateSize = function () {
                e.prototype.updateSize.call(this), zr()
            }),
            ...
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (ma -= 1) ||
                            window.removeEventListener("touchmove", Sa, {
                                passive: !1,
                            })
                }),
                (e.prototype.tryStart = function (e) {
                    ...
                    return (
                        !(
                            !t ||
                            (this.handleSelector && !F(n, this.handleSelector))
                        ) &&
                        ((this.subjectEl = t),
                        (this.isDragging = !0),
                        (this.wasTouchScroll = !1),
                ...
                (e.prototype.shouldIgnoreMouse = function () {
                    return ga || this.isTouchDragging
                }),
                (e.prototype.cancelTouchScroll = function () {
                    this.isDragging && (ya = !0)
                }),
    ...
    var Da = (function () {
            ...
            return (
                ...
                (e.prototype.cleanup = function () {
                    this.mirrorEl && (z(this.mirrorEl), (this.mirrorEl = null)),
                        (this.sourceEl = null)
                }),
        ...
        Ra = "function" == typeof performance ? performance.now : Date.now,
        Ta = (function () {
            function e() {
                var e = this
                ;(this.isEnabled = !0),
            ...
            return (
                ...
                (e.prototype.buildCaches = function () {
                    return this.queryScrollEls().map(function (e) {
                        return e === window ? new wa(!1) : new Ca(e, !1)
                    })
                }),
    ...
    function _a(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && kn(e.dateSpan, t.dateSpan))
        )
    }
    function Ia(e, t) {
        for (
    ...
    var Pa = (function (e) {
            function t(t) {
                ...
                ;(n.handlePointerDown = function (e) {
                    ...
                    (n.dragging = new ka(t.el)),
                    (n.dragging.autoScroller.isEnabled = !1)
                var o = (n.hitDragging = new xa(n.dragging, di(t)))
                return (
        ...
        function t(n) {
            ...
            ;(o.subjectEl = null),
                ...
                (o.handlePointerDown = function (e) {
                    ...
                    var d = r.isValidSegDownEl(t) && !F(t, ".fc-event-resizer")
                    i.setIgnoreMove(!d),
                        (o.isDragging =
                            d &&
                            ...
                            if (a === t) {
                                ...
                                for (
                                    var v = {
                                        ...
                                        g = {},
                                        m = 0,
                                        y = t.getCurrentData().pluginHooks
                                            .eventDropTransformers;
                                    m < y.length;
                                    m++
                                ) {
    ...
    var Aa = (function () {
            function e(e) {
                ...
                ;(this.context = e),
                    ...
                    (this.onDocumentPointerDown = function (e) {
                        var n = t.context.options.unselectCancel,
                            r = e.origEvent.target
                        ;(t.matchesCancel = !!F(r, n)),
                            (t.matchesEvent = !!F(r, Ha.SELECTOR))
                    }),
                ...
                var n = (this.documentPointer = new Ea(document))
        ...
        Wa = (function () {
            function e(e, t) {
                ...
                var o = (this.hitDragging = new xa(e, pi))
                ;(o.requireInitial = !1),
            ...
            return (
                (e.prototype.buildDragMeta = function (e) {
                    return "object" == typeof this.suppliedDragMeta
                        ? gi(this.suppliedDragMeta)
                        : "function" == typeof this.suppliedDragMeta
                        ? gi(this.suppliedDragMeta(e))
                        : gi(
                              (t = (function (e, t) {
                                  var n = hi.dataAttrPrefix,
                                      r = (n ? n + "-" : "") + t
    ...
    var Va = (function () {
        ...
        Ba = lo({
            componentInteractions: [Pa, Na, Ha, Oa],
            calendarInteractions: [Aa],
            elementDraggingImpl: ka,
            optionRefiners: Ua,
            listenerRefiners: La,
        }),
        ja = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderHScrollLayout = function (e, t, n, r) {
                    ...
                    var i = this.props,
                        a = this.context,
                        s = !i.forPrint && Qi(a.options),
                        l = !i.forPrint && ea(a.options),
                        u = []
                    return (
                        e &&
                            u.push({
    ...
    var ts = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this.props,
                    t = this.context,
                    n = t.options.eventTimeFormat || Qa,
    ...
    function os(e, t, n, o, i, a, s, l) {
        ...
        !0 === n || !0 === o
            ? (function (e, t, n, r) {
                  as(e, t, n, !0, function (e) {
                      return e.bottom <= r
                  })
              })(c, d, u, a)
            : "number" == typeof n
            ? (function (e, t, n, r) {
                  as(e, t, n, !1, function (e, t) {
                      return t < r
                  })
              })(c, d, u, n)
            : "number" == typeof o &&
              (function (e, t, n, r) {
                  as(e, t, n, !0, function (e, t) {
                      return t < r
                  })
              })(c, d, u, o)
        for (var E = 0; E < s; E += 1) {
    ...
    function as(e, t, n, r, o) {
        ...
        function f(e) {
            ...
            if (!a[n]) {
                a[n] = !0
                for (var r = t.firstCol; r <= t.lastCol; r += 1) s[r].push(e)
            }
        }
        function h(n, r, o) {
            var i = n.seg,
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    ...
                    r = this.context,
                    o = t.cells.length,
                    i = qa(t.businessHourSegs, o),
                    a = qa(t.bgEventSegs, o),
                    s = qa(this.getHighlightSegs(), o),
                    l = qa(this.getMirrorSegs(), o),
                    u = os(
                        t.cells,
                        t.fgEventSegs,
                        t.dayMaxEvents,
    ...
    ss.addStateEquality({ segHeights: Ve })
    var ls = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this
                return (
        ...
        cs = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this
                return (
                    (t.splitBusinessHourSegs = st(Ga)),
                    (t.splitBgEventSegs = st(Ga)),
                    (t.splitFgEventSegs = st(Ga)),
                    (t.splitDateSelectionSegs = st(Ga)),
                    (t.splitEventDrag = st(Ya)),
                    (t.splitEventResize = st(Ya)),
                    (t.buildBuildMoreLinkText = st(ds)),
                    (t.rowRefs = new zi()),
    ...
    function gs(e, t) {
        var n = new Oi(e.renderRange, t)
        return new Ai(n, /year|month|week/.test(e.currentRangeUnit))
    }
    var ms = lo({
            ...
            return (
                ...
                (t.prototype.render = function () {
                    return this.props.slatMetas.map(function (e) {
                        return Ar("tr", { key: e.key }, Ar(Ss, r({}, e)))
                    })
                }),
                t
            )
        ...
        ws = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderHScrollLayout = function (
                    ...
                    var u = this.context,
                        c = this.props,
                        d = !c.forPrint && Qi(u.options),
                        p = !c.forPrint && ea(u.options),
                        f = []
                    e &&
                        f.push({
                            type: "header",
    ...
    function Hs(e) {
        ...
        if (null == e.forwardPressure) {
            for (t = 0; t < r.length; t += 1)
                Hs((n = r[t])), (o = Math.max(o, 1 + n.forwardPressure))
            e.forwardPressure = o
        }
    }
    function Os(e, t, n, r) {
    ...
    var Us = bt({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
        Ls = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this
            }
    ...
    hi.timeGridEventCondensedHeight = 30
    var Vs = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this
            }
            return (
                ...
                (t.prototype.renderPrintFgSegs = function (e) {
                    var t = this.props
                    return (e = gn(e, this.context.options.eventOrder)).map(
                        function (e) {
                            return Ar(
                                "div",
                                {
                                ...
                                r(
                                    {
                                        ...
                                        isCondensed:
                                            e.bottom - e.top <
                                            hi.timeGridEventCondensedHeight,
                                    },
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    ...
                    Ps(e, i.date, i.slatCoords, o.options.eventMinHeight)
        ...
        zs = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this
                return (
                    (t.splitFgEventSegs = st(xs)),
                    (t.splitBgEventSegs = st(xs)),
                    (t.splitBusinessHourSegs = st(xs)),
                    (t.splitNowIndicatorSegs = st(xs)),
                    (t.splitDateSelectionSegs = st(xs)),
                    (t.splitEventDrag = st(_s)),
                    (t.splitEventResize = st(_s)),
                    (t.rootElRef = Lr()),
                    (t.cellElRefs = new zi()),
                    t
                )
    ...
    var Xs = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this
            return (
                (t.buildTimeColsModel = st(Ks)), (t.buildSlatMetas = st(Zs)), t
            )
        }
        return (
            n(t, e),
    ...
    var el = bt({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
        tl = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this
            }
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = e.seg,
                        r = t.options.eventTimeFormat || el
                    return Ar(
                        na,
                        {
                            seg: n,
    ...
    var ol = (function (e) {
        ...
        return (
            ...
            (t.prototype.renderSegList = function (e, t) {
                ...
                return Ar(Ii, { unit: "day" }, function (e, n) {
                    for (var s = [], l = 0; l < a.length; l += 1) {
                        var u = a[l]
                        if (u) {
                            var c = t[l].toISOString()
                            s.push(
                                Ar($s, { key: c, dayDate: t[l], todayRange: n })
                            )
                            for (
    ...
    ;(ul.prototype.classes = {
        ...
        (ul.prototype.baseIconClass = "fa"),
        (ul.prototype.iconClasses = {
            close: "fa-times",
        ...
        (ul.prototype.rtlIconClasses = {
            prev: "fa-chevron-right",
            next: "fa-chevron-left",
            prevYear: "fa-angle-double-right",
            nextYear: "fa-angle-double-left",
        }),
        (ul.prototype.iconOverrideOption = "bootstrapFontAwesome"),
        (ul.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome"),
        (ul.prototype.iconOverridePrefix = "fa-")
    var cl = lo({ themeClasses: { bootstrap: ul } })
    var dl = lo({
        eventSourceDefs: [
            {
                parseMeta: function (e) {
                        ...
                        !t &&
                            ...
                            (t = (function (e) {
                                ...
                                if (
                                    ...
                                    return e
                                if (
                                    (t = /^https:\/\/www.googleapis.com\/calendar\/v3\/calendars\/([^/]*)/.exec(
                                        e
                                    )) ||
    ...
    return (
        ...
        (e.Calendar = va),
        (e.CalendarApi = Fn),
        (e.CalendarContent = bi),
        (e.CalendarDataManager = Jo),
        (e.CalendarDataProvider = si),
        (e.CalendarRoot = Ri),
        (e.Component = Or),
        (e.ContentHook = vo),
        ...
        (e.DayTimeColsView = Xs),
        (e.DelayedRunner = Zo),
        (e.Draggable = Va),
        (e.ElementDragging = fi),
        (e.ElementScrollController = Pr),
        (e.Emitter = xr),
        (e.EventApi = Bn),
        (e.EventRoot = na),
        (e.EventSourceApi = V),
        (e.FeaturefulElementDragging = ka),
        (e.Fragment = Wr),
        (e.Interaction = ui),
        (e.ListView = ol),
        (e.MountHook = mo),
        (e.NamedTimeZoneImpl = li),
        (e.NowIndicatorRoot = ia),
        (e.NowTimer = Ii),
        (e.PointerDragging = Ea),
        (e.PositionCache = _r),
        (e.RefMap = zi),
        (e.RenderHook = fo),
        ...
        (e.TableView = ja),
        (e.Theme = Hr),
        (e.ThirdPartyDraggable = Fa),
        (e.TimeCols = Fs),
        (e.TimeColsSlatsCoords = Ts),
        (e.TimeColsView = ws),
        (e.ViewApi = Un),
        ...
        (e.compareObjs = Fe),
        (e.computeEdges = wr),
        (e.computeFallbackHeaderFormat = Ti),
        ...
        (e.getScrollGridClassNames = Ki),
        (e.getScrollbarWidths = br),
        (e.getSectionClassNames = Ji),
        (e.getSectionHasLiquidHeight = Bi),
        (e.getSegMeta = bn),
        ...
        (e.getStickyFooterScrollbar = ea),
        (e.getStickyHeaderDates = Qi),
        ...
        (e.hasShrinkWidth = Xi),
        (e.identity = Pt),
        (e.interactionSettingsStore = pi),
        (e.interactionSettingsToStore = di),
        (e.intersectRanges = on),
        (e.intersectRects = lr),
        (e.isArraysEqual = at),
        (e.isColPropsEqual = qi),
        ...
        (e.render = Ur),
        (e.renderChunkContent = Gi),
        (e.renderFill = ca),
        (e.renderMicroColGroup = Yi),
        (e.renderScrollShim = $i),
        (e.requestJson = Fo),
        (e.sanitizeShrinkWidth = Zi),
        (e.setElSeg = pn),
        (e.setRef = Kr),
