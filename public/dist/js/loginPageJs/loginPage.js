...
!(function (a, b) {
    ...
    function I() {
        d.addEventListener
            ...
            : (d.detachEvent("onreadystatechange", J),
        ...
        return (
            c ||
                ...
                ("none" !== c && c) ||
                    ...
                    (b = (Ia[0].contentWindow || Ia[0].contentDocument)
                        .document),
                    b.write(),
                    b.close(),
                    (c = Ka(a, b)),
    ...
    n.extend({
        ...
        n.each(["height", "width"], function (a, b) {
            n.cssHooks[b] = {
                get: function (a, c, d) {
                    if (c)
                        return Wa.test(n.css(a, "display")) &&
                            0 === a.offsetWidth
                            ? Oa(a, Ya, function () {
                                  return eb(a, b, d)
                              })
        ...
        (n.cssHooks.marginRight = Ta(l.reliableMarginRight, function (a, b) {
            if (b)
                return Oa(a, { display: "inline-block" }, Ra, [
                    a,
                    "marginRight",
                ])
        })),
    ...
    ;(n.Tween = fb),
        (fb.prototype = {
            ...
            cur: function () {
                ...
                return a && a.get
                    ? a.get(this)
                    : fb.propHooks._default.get(this)
            },
            run: function (a) {
                var b,
